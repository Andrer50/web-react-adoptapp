...
const selectTriggerVariants = cva(
  "flex w-fit items-center justify-between gap-1.5 border border-input bg-transparent whitespace-nowrap transition-colors outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 data-placeholder:text-muted-foreground *:data-[slot=select-value]:line-clamp-1 *:data-[slot=select-value]:flex *:data-[slot=select-value]:items-center *:data-[slot=select-value]:gap-1.5 dark:bg-input/30 dark:hover:bg-input/50 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      size: {
        sm: "h-8 py-1 pr-2 pl-2.5 rounded-md text-xs md:text-sm",
        md: "h-9 py-1.5 pr-2 pl-2.5 rounded-lg text-sm",
        default: "h-9 py-1.5 pr-2 pl-2.5 rounded-lg text-sm",
        lg: "h-10 py-2 pr-2.5 pl-3 rounded-lg text-sm",
        xl: "h-12 py-3 pr-3.5 pl-4 rounded-xl text-base",
      },
    },
    defaultVariants: {
      size: "default",
